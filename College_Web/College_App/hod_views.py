    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                ...
                subject = 'Andhra Loyola College User Credentials'
                message = f'Hi {user.first_name} {user.last_name}, Welcome to Andhra Loyola College\n\n\n Your Login Details....\n\n\tUsername : {user.email}\n\tPassword : {user.first_name}@123\n\n\tYour Unique ID : {user.id}\n\n\nThank You,\nAdmin,\nALC'
                email_from = settings.EMAIL_HOST_USER
                recipient_list = [user.email ]
                send_mail( subject, message, email_from, recipient_list )
                messages.success(request,"Mail sent to created staff")
    ...
    if request.method == 'POST':
        if student_form.is_valid():
            ...
            try:
                ...
                recipient_list = [user.email ]
                send_mail( subject, message, email_from, recipient_list )
                messages.success(request,"Mail sent to created student")
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                ...
                subject = 'Andhra Loyola College User Credentials are updated'
                message = f'Hi {user.first_name} {user.last_name}, Welcome to Andhra Loyola College\n\n\n Your Updated Login Details....\n\n\tUsername : {user.email}\n\tPassword : {password}\n\tYour Unique ID : {user.id}\n\n\nThank You,\nAdmin,\nALC'
                email_from = settings.EMAIL_HOST_USER
                recipient_list = [user.email ]
                send_mail( subject, message, email_from, recipient_list )
                messages.success(request,"Mail sent to updated staff")
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                ...
                recipient_list = [user.email ]
                send_mail( subject, message, email_from, recipient_list )
                messages.success(request,"Mail sent to updated student")
    ...
    if request.method == 'POST':
        try:
            if form.is_valid():
                ...
                custom_user.save()
                subject = 'Andhra Loyola College User Credentials'
                message = f'Hi {custom_user.first_name} {custom_user.last_name}, Welcome to Andhra Loyola College\n\n\n Your Login Details....\n\n\tUsername : {custom_user.email}\n\tPassword : {password}\n\n\nThank You,\nAdmin,\nALC'
                email_from = settings.EMAIL_HOST_USER
                recipient_list = [custom_user.email ]
                send_mail( subject, message, email_from, recipient_list )
                messages.success(request,"Your Profile was Updated and Mail sent to you")
    ...
    try:
        ...
        body = {
            'notification': {
                ...
                'icon': static('dist/img/logotrans.png')
            },
