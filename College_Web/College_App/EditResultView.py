    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                internal_test_1 = form.cleaned_data.get('internal_test_1')
                internal_test_2 = form.cleaned_data.get('internal_test_2')
                ...
                result.internal_test_1 = internal_test_1
                result.internal_test_2 = internal_test_2
